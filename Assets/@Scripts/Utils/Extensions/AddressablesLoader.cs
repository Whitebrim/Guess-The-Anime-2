...
public static class AddressablesLoader
{
    ...
    {
        if (AddressablesCache.Instance.Cache.TryGetValue(asset, out Object product))
        {
            return (T)product;
        }
    ...
    public static async Task<T> LoadAndCacheAsync<T>(this AssetReferenceT<T> asset) where T : Object
    {
        ...
        {
            if (x.OperationException == null && x.Result != null)
            {
                AddressablesCache.Instance.Cache[asset] = x.Result;
            }
        };
